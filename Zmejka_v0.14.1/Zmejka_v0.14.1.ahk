...
Tu_on_u := A_ScriptDir "\p_libs\Tu_v0.6.0.cpython-311.pyc"
PCTT := A_ScriptDir "\p_libs\Plot_CSV_Time_Threshhold_v0.8.0.cpython-311.pyc"
FMT := A_ScriptDir "\p_libs\FDS_Mesh_Tools.cpython-311.pyc"
...
FSF := A_ScriptDir "\p_libs\FSF_v0.6.0.cpython-311.pyc"
FSF_FDS5 := A_ScriptDir "\p_libs\FSF_v0.6.0_FDS5.cpython-311.pyc"
...
Gui, Add, Text, x22 y179 w120 h40 , Инструменты сеточной хирургии (Partition + Refine + Coarsen)
Gui, Add, Button, x172 y179 w100 h40 gRunFMT, FMT
Gui, Add, Text, x325 y285 w160 h20 , ID:%UniqueID%
...
Gui, Show, h310 w395, ZmejkaFDS v0.14.1
