...
Gui, Tab, Settings
Gui, Add, Checkbox, x22 y29 w120 h20 vChekAlwDTR, Allow DT_RESTART
Gui, Add, Edit, x152 y29 w100 h20 , 100000
...
Gui, Show, h310 w395, Zmejka_v0.10.0
Return
...
;	CheckFDSInstallation()
	...
	if InStr(fileName, "_tout")
	{
		...
		; MsgBox, The file name contains _tout.
	}
	else
	{
		FileMove, %folderPath%\%fileName%*.*, %A_ScriptDir%\, 1
		...
		filePath := A_ScriptDir "\" fileName ".fds"
		OutfilePath := A_ScriptDir "\" fileName ".out"
		; MsgBox, The file name does NOT contain _tout.
	}
