...
|	**3**	|	[**SPDZ**](https://github.com/firegoaway/INIT_md)	![spdz.ico](https://raw.githubusercontent.com/firegoaway/Zmejka/refs/heads/main/.gitpics/spdz.ico	| Расчитывает и определяет параметры ***систем противодымной защиты*** с помощью полевой модели. Позволяет рассчитать эффективность как отдельных элементов системы противодымной защиты, так и эффективность системы в целом.	|
