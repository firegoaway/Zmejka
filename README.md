...
|	**А**	|	[**Вводная инструкция. Скачивание, запуск и обновление Змейки**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/1%20Вводная%20инструкция%20для%20пользователя%20Змейки.md)	|
|	**Б**	|	[**Инструкция по запуску стандартного расчёта**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/2%20Инструкция%20по%20запуску%20стандартного%20расчёта.md)	|
|	**В**	|	[**Инструкция по запуску ускоренного расчёта**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/3%20Инструкция%20по%20запуску%20ускоренного%20расчёта.md)	|
|	**Г**	|	[**Инструкция по параметрам расчёта**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/4%20Инструкция%20по%20параметрам%20расчёта.md)	|
|	**Д**	|	[**Инструкция по расчёту tпор и построению графика dэфф**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/7%20Инструкция%20по%20расчёту%20tпор%20и%20построению%20графика%20dэфф.md)	|
|	**Е**	|	[**Инструкция по построению графика мощности пожара**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/5%20Инструкция%20по%20построению%20графика%20мощности%20пожара.md)	|
|	**Ж**	|	[**Инструкция по построению графика плотности людских потоков**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/6%20Инструкция%20по%20построению%20графика%20плотности%20людских%20потоков.md)	|

### Если возникли проблемы с запуском

|	№ п/п	|	Действие	|
|---------|---------|
|	**З**	|	[**Инструкция по устранению проблем с запуском и корректной работой**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/Инструкция%20по%20устранению%20проблем%20с%20запуском%20и%20корректной%20работой.md)	|

### FAQ по Змейке

|	№ п/п	|	Действие	|
|---------|---------|
|	**И**	|	[**Ответы на часто задаваемые вопросы**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/Сборник%20лайфхаков%20по%20Змейке.md)	|
...
|	№ п/п	|	Модуль	|	Описание	|
|---------|---------|---------|
|	**1**	|	[**Модуль ускорения моделирования пожара**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.4/ug/3%20Инструкция%20по%20запуску%20ускоренного%20расчёта.md)	| Позволяет произвести ускорение моделирования пожара для гражданских и производственных объектов, а также ускорение теплотехнических расчётов без вреда для методической точности результатов моделирования.	|
...
|	№ п/п	|	Планируемое обновление	|
|---------|---------|
|	**1**	|	Обеспечить поддержку SmokeView версий 6.10 и выше	|
|	**2**	|	Реализовать циклическую конвертацию FDS 6 -> FDS 5 -> FDS 6 для Fenix+ версий 3.6.х.х	|
|	**3**	|	Внедрить модуль детального редактирования очага пожара, (тип распространения, объемно-массовые характеристики, учет АУПТ совместно с расчетом по приложению 11).<br>Внедрить контактное окно с QwenAPI, в котором выполняется обоснование характеристик и свойств очага пожара	|
|	**4**	|	"Калькулятор реакции FDS 6" перенести во вкладку "Параметры". Переименовать в "Редактор химических реакций FDS". Внедрить автоматическое распознавание и поддержку реакций FDS 5	|
|	**5**	|	VBA "CalculateFireScenarioParams" интегрировать в Змейку	|
|	**6**	|	На графике `d_эфф` добавить время начала эвакуации.<br>Исправить автоматическое подтягивание Fpom из ini	|
|	**7**	|	Переработать график АУПТ, исправить имеющиеся формулы, добавить корректирующие выражения для нестационарных тепловых потоков	|
|	**8**	|	Расширить возможности Insert_DEVC:<br>добавить все виды извещателей, включая аспирационные	|
|	**9**	|	Расширить возможности PCTT:<br>добавить FED индикацию для расчетов по методике 533,<br>добавить все виды извещателей, включая аспирационные,<br>добавить логарифмический преобразователь для "OPTICAL DENSITY" и "VISIBILITY"	|
|	**10**	|	Добавить модуль расчета FED согласно методике 533	|
|	**11**	|	Зарефакторить PFED	|
|	**12**	|	Зарефакторить HRRP	|
|	**13**	|	Объединить PCTT, PFED и HRRP в единый модуль с UI	|
...
> ZmejkaFDS.exe - **3060937cd6e78cb55d82bbbef55ddc24**

### Актуальный релиз
> [***Скачать ZmejkaFDS***](https://github.com/firegoaway/Zmejka/releases/download/zmejkav0144/Zmejka_v0.14.4.zip)

> [***Скачать***](https://github.com/firegoaway/Zmejka/releases/download/zmejkav0144/Zmejka_v0.14.4.zip)
