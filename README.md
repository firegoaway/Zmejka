...
|---------|---------|
|	**1**	|	Обеспечить поддержку SmokView версий 6.10 и выше	|
|	**2**	|	Реализовать циклическую конвертацию FDS 6 -> FDS 5 -> FDS 6 для Fenix+ версий 3.6.х.х	|
|	**3**	|	Внедрить модуль детального редактирования очага пожара, (тип распространения, объемно-массовые характеристики, учет АУПТ совместно с расчетом по приложению 11).<br>В модуль сделать контактное окно с QwenAPI, в котором выполняется обоснование характеристик и свойств очага пожара	|
