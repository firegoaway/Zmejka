...
|	**А**	|	[**Вводная инструкция. Скачивание, запуск и обновление Змейки**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/1%20Вводная%20инструкция%20для%20пользователя%20Змейки.md)	|
|	**Б**	|	[**Инструкция по запуску стандартного расчёта**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/2%20Инструкция%20по%20запуску%20стандартного%20расчёта.md)	|
|	**В**	|	[**Инструкция по запуску ускоренного расчёта**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/3%20Инструкция%20по%20запуску%20ускоренного%20расчёта.md)	|
|	**Г**	|	[**Инструкция по параметрам расчёта**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/4%20Инструкция%20по%20параметрам%20расчёта.md)	|
|	**Д**	|	[**Инструкция по расчёту tпор и построению графика dэфф**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/7%20Инструкция%20по%20расчёту%20tпор%20и%20построению%20графика%20dэфф.md)	|
|	**Е**	|	[**Инструкция по построению графика мощности пожара**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/5%20Инструкция%20по%20построению%20графика%20мощности%20пожара.md)	|
|	**Ж**	|	[**Инструкция по построению графика плотности людских потоков**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/6%20Инструкция%20по%20построению%20графика%20плотности%20людских%20потоков.md)	|

### Если возникли проблемы с запуском

|	№ п/п	|	Действие	|
|---------|---------|
|	**З**	|	[**Инструкция по устранению проблем с запуском и корректной работой**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/Инструкция%20по%20устранению%20проблем%20с%20запуском%20и%20корректной%20работой.md)	|

### FAQ по Змейке

|	№ п/п	|	Действие	|
|---------|---------|
|	**И**	|	[**Ответы на часто задаваемые вопросы**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/Сборник%20лайфхаков%20по%20Змейке.md)	|
...
|	№ п/п	|	Модуль	|	Описание	|
|---------|---------|---------|
|	**1**	|	[**Модуль ускорения моделирования пожара**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.14.3/ug/3%20Инструкция%20по%20запуску%20ускоренного%20расчёта.md)	| Позволяет произвести ускорение моделирования пожара для гражданских и производственных объектов, а также ускорение теплотехнических расчётов без вреда для методической точности результатов моделирования.	|
...
> ZmejkaFDS.exe - **ffdbb9d9c7166068895977fed46151b6**

### Актуальный релиз
> [***Скачать ZmejkaFDS***](https://github.com/firegoaway/Zmejka/releases/download/zmejkav0143/Zmejka_v0.14.3.zip)

> [***Скачать***](https://github.com/firegoaway/Zmejka/releases/download/zmejkav0143/Zmejka_v0.14.3.zip)
