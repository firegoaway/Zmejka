...
|	А	|	**Инструкция по запуску стандартного расчёта**	|
|	Б	|	**Инструкция по запуску стандартного расчёта**	|
|	В	|	Ознакомьтесь с **инструкциями**	|
|	Г	|	Ознакомьтесь с **инструкциями**	|
|	Д	|	Ознакомьтесь с **инструкциями**	|

## Если возникли проблемы с запуском
|	№ п/п	|	Действие	|
|---------|---------|
|	1	|	Ознакомьтесь с [**Инструкцией**](https://github.com/firegoaway/Zmejka/blob/main/Zmejka_v0.12.21/misc/Инструкция.txt)	|
