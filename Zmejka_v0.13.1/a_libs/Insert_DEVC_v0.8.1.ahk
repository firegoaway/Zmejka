...
Tu_on_u := A_ScriptDir "\..\p_libs\Tu_v0.5.0.cpython-311.pyc"
INIT_md := A_ScriptDir "\..\p_libs\INIT_md_v0.1.0.cpython-311.pyc"
...
Gui, Add, Tab3, x2 y-1 h468 w184 +BackgroundTrans, Главная|АУПТ|СПДЗ|
Gui, Tab, Главная
...
Gui, Tab, СПДЗ
Gui, Add, Button, x12 y59 w160 h30 gRunINITmd, Расчёт СПДЗ

Gui, Show, x130 y134 h468 w184, Insert_DEVC_v0.8.1
Return
