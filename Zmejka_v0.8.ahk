...
Gui, Add, Edit, x5 y5 vFolderPath w250 h20 r1, % "Enter fds file folder path here"
Gui, Add, Edit, x5 y30 vFileName w250 h20 r1, % "File name is stored here"
Gui, Add, Button, x260 y15 gBrowseFileButton, Browse .fds
Gui, Add, Button, x10 y70 gStartButton, Start
Gui, Add, Button, x10 y100 gPauseButton, Pause
Gui, Add, Button, x60 y70 gStopButton, Stop
Gui, Add, Button, x60 y100 gKillButton, Kill
Gui, Add, Button, x10 y130 gCheckFDS, Check FDS
Gui, Add, Button, x112 y69 w80 h20 gBrowseFDSButton, Browse fds.exe
Gui, Add, Edit, x202 y69 w130 h20 vFDSpath, %FDSpath%
Gui, Add, Button, x112 y99 w80 h20 gBrowseMPIButton, Browse mpi
Gui, Add, Edit, x202 y99 w130 h20 vMPIpath, %MPIpath%
Gui, Show
Return
