...
:: Directories to add
set "dir1=%systemDrive%\Program Files\Zmejka_v0.12.19"
set "dir2=%systemDrive%\Program Files\Zmejka_v0.12.19\FDS5"
set "dir3=%systemDrive%\Program Files\Zmejka_v0.12.19\FDS5\dll"
...
echo !currentPath! | find /i "%dir7%" >nul || set "newPath=!dir7!;!currentPath!"
echo !currentPath! | find /i "%dir8%" >nul || set "newPath=!dir8!;!newPath!"
echo !currentPath! | find /i "%dir9%" >nul || set "newPath=!dir9!;!newPath!"
